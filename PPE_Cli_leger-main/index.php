...
<body>
    <center>
        ...
        switch ($page) {
            ...
            case 2:
                require_once("controleur/gestion_clients.php");
                break;
            case 3:
                require_once("controleur/gestion_techniciens.php");
                break;
            case 4:
                require_once("controleur/gestion_produits.php");
                break;
            case 5:
                require_once("controleur/gestion_cat_produits.php");
                break;
            case 6:
                require_once("controleur/gestion_commandes.php");
                break;
            case 7:
                require_once("controleur/gestion_devis.php");
                break;
            case 8:
                require_once("controleur/gestion_ligne_com.php");
                break;
            case 9:
                require_once("controleur/gestion_interventions.php");
                break;
            case 10: /* Déconnexion - handled at the beginning of the file */
                break;
